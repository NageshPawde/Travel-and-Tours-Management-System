...
public class Viewhotel extends JFrame implements ActionListener{
    ...
    public Viewhotel(String username){
        ...
        l1 = new JLabel("BOOKED HOTEL DETAILS");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/Nagesh1.jpg"));
       ...
       try{
           ...
           while(rs.next()){
               ...
               l15.setText(rs.getString("rooms"));
